  ...
  return (
    ...
    >
      ...
      >
        ...
        {isRunning ? (
          <span className="flex items-center gap-1.5 text-syn-teal running-pill">
      ...
      {bottomPanelOpen && (
        <div
          ref={scrollRef}
          className="flex-1 overflow-y-auto px-3 pb-2 font-mono text-xs leading-relaxed [&::selection]:bg-[rgba(108,99,255,0.35)]"
          style={{
            // Custom selection color for log text
